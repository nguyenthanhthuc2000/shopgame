...
return [
    ...
    */
    ...
    'ascii' => 'Trường :attribute chỉ có thể chứa các ký tự và biểu tượng đơn byte.',
    ...
    'hex_color' => 'Trường :attribute phải là một màu sắc hợp lệ theo mã hex.',
    ...
    'lte' => [
        ...
        'file' => 'Trường :attribute không được lớn hơn :value kilobytes.',
        'numeric' => 'Trường :attribute không được lớn hơn :value.',
        'string' => 'Trường :attribute không được lớn hơn :value ký tự.',
    ],
    ...
    'multiple_of' => 'Trường :attribute phải là bội của :value.',
    ...
    'password' => [
        ...
        'uncompromised' => 'Mật khẩu :attribute đã xuất hiện trong một vụ rò rỉ dữ liệu. Vui lòng chọn mật khẩu khác.',
    ],
