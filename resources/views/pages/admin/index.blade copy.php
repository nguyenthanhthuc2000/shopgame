...
<html lang="en">
  <head>
    ...
    <link href="{{ asset('assets/dist/css/tabler-payments.min') }}" rel="stylesheet"/>
    <link href="{{ asset('assets/dist/css/tabler-vendors.min') }}" rel="stylesheet"/>
          ...
          <div class="container-xl">
            <div class="row row-deck row-cards">
                      ...
                      <div class="card-body card-body-scrollable card-body-scrollable-shadow">
                        <div class="divide-y">
                          ...
                          <div>
                            <div class="row">
                              <div class="col-auto">
                                <span class="avatar" style="background-image: url({{ asset('assets/static/avatars/002f.jpg') }}"></span>
                              </div>
                              <div class="col">
                                <div class="text-truncate">
                          ...
                          <div>
                            <div class="row">
                              <div class="col-auto">
                                <span class="avatar" style="background-image: url({{ asset('assets/static/avatars/003f.jpg') }}"></span>
                              </div>
                              <div class="col">
                                <div class="text-truncate">
                          ...
                          <div>
                            <div class="row">
                              <div class="col-auto">
                                <span class="avatar" style="background-image: url({{ asset('assets/static/avatars/006m.jpg') }}"></span>
                              </div>
                              <div class="col">
                                <div class="text-truncate">
                          ...
                          <div>
                            <div class="row">
                              <div class="col-auto">
                                <span class="avatar" style="background-image: url({{ asset('assets/static/avatars/004f.jpg') }}"></span>
                              </div>
                              <div class="col">
                                <div class="text-truncate">
                          ...
                          <div>
                            <div class="row">
                              <div class="col-auto">
                                <span class="avatar" style="background-image: url({{ asset('assets/static/avatars/007m.jpg') }}"></span>
                              </div>
                              <div class="col">
                                <div class="text-truncate">
                          ...
                          <div>
                            <div class="row">
                              <div class="col-auto">
                                <span class="avatar" style="background-image: url({{ asset('assets/static/avatars/009m.jpg') }}"></span>
                              </div>
                              <div class="col">
                                <div class="text-truncate">
                          ...
                          <div>
                            <div class="row">
                              <div class="col-auto">
                                <span class="avatar" style="background-image: url({{ asset('assets/static/avatars/010m.jpg') }}"></span>
                              </div>
                              <div class="col">
                                <div class="text-truncate">
                          ...
                          <div>
                            <div class="row">
                              <div class="col-auto">
                                <span class="avatar" style="background-image: url({{ asset('assets/static/avatars/005f.jpg') }}"></span>
                              </div>
                              <div class="col">
                                <div class="text-truncate">
                          ...
                          <div>
                            <div class="row">
                              <div class="col-auto">
                                <span class="avatar" style="background-image: url({{ asset('assets/static/avatars/006f.jpg') }}"></span>
                              </div>
                              <div class="col">
                                <div class="text-truncate">
                  ...
                  <div class="card-table table-responsive">
                    <table class="table table-vcenter">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td class="w-1">
                            <span class="avatar avatar-sm" style="background-image: url({{ asset('assets/static/avatars/002m.jpg') }}"></span>
                          </td>
                          <td class="td-truncate">
                            <div class="text-truncate">
                              justify-content:between ⇒ justify-content:space-between (#29734)
                        ...
                        <tr>
                          <td class="w-1">
                            <span class="avatar avatar-sm" style="background-image: url({{ asset('assets/static/avatars/003m.jpg') }}"></span>
                          </td>
                          <td class="td-truncate">
                            <div class="text-truncate">
                              Update change-version.js (#29736)
              ...
              <div class="col-md-6 col-lg-4">
                <a href="https://github.com/sponsors/codecalm" class="card card-sponsor" target="_blank" rel="noopener" style="background-image: url({{ asset('assets/static/sponsor-banner-homepage.svg') }})" aria-label="Sponsor Tabler!">
                  ...
                  <div class="table-responsive">
                    <table class="table card-table table-vcenter">
                      ...
                      <tr>
                        ...
                        <td>
                          <span class="avatar avatar-sm" style="background-image: url({{ asset('assets/static/avatars/001f.jpg') }}"></span>
                        </td>
                      </tr>
                    </table>
                  </div>
