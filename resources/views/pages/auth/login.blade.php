        ...
        <div class="container" id="container">
            <div class="form-container sign-up-container">
                <form action="{{ route('auth.register') }}" id="register-form" method="POST">
                    ...
                    <button class="ghost for-mobbile signIn" type="button">Đăng Nhập Ngay</button>
                </form>
            </div>
            ...
            <div class="overlay-container">
                <div class="overlay">
                    <div class="overlay-panel overlay-left">
                        ...
                        <button class="ghost signIn">Đăng Nhập Ngay</button>
                    </div>
                    <div class="overlay-panel overlay-right">
                        <h1>Chào bạn!</h1>
                        <p>Nhập thông tin cá nhân của bạn và bắt đầu tìm nick ngon giá rẽ của chúng tôi.</p>
                        <button class="ghost signUp">Đăng Ký Ngay</button>
                    </div>
                </div>
            </div>
        </div>
