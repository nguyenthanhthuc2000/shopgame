    ...
    <div class="product-section mt-150 mb-80">
        <div class="container">
            ...
            <div class="alert-custom alert alert-success">
                <p class="mb-0"><strong>Nạp từ ATM/MOMO vào shop cộng thêm 20% giá trị</strong> <a href="{{ route('home.deposit') }}">tại đây <img src="{{ asset('assets/images/hot.gif') }}" alt="nickdaoquan.vn"></a> (nạp 100k nhận 120k)</p>
                
                <p class="mb-0"><strong>Chú ý:&nbsp;Sau khi mua tài khoản thành công, bạn hãy thực hiện đổi mật khẩu</strong></p>
                
                <p class="mb-0">Link đổi mật khẩu:&nbsp;<a href="https://forum.ngocrongonline.com/app/?for=event&do=changepass">https://forum.ngocrongonline.com/app/?for=event&do=changepass</a></p>
            
                <p class="mb-0">Liên hệ nhập acc giá cao <a href="https://www.facebook.com/profile.php?id=61569589252659">tại đây <img src="{{ asset('assets/images/hot.gif') }}" alt="nickdaoquan.vn"></a></a></p>
            </div>
