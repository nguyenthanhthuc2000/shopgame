                ...
                <div class="navbar">
                    <div class="container-xl">
                        <ul class="navbar-nav">
                            ...
                            @php
                                $activeTransaction =
                                    Route::is('cards.tran.index') ||
                                        Route::is('banks.tran.index') ||
                                        Route::is('accounts.tran.index') ?? false;
                            @endphp
                            <li class="nav-item dropdown {{ $activeTransaction ? 'active' : '' }}">
                                <a class="nav-link dropdown-toggle" href="#transaction" data-bs-toggle="dropdown"
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item text-pink" href="/admin/account-transactions"
                                        rel="noopener">
                                    ...
                                    <a class="dropdown-item" href="/admin/bank-transactions" rel="noopener">
                                        Nạp ATM
                                    </a>
                                </div>
                            </li>
                        ...
                        <div class="col-lg-auto ms-lg-auto">
                            <ul class="list-inline list-inline-dots mb-0">
                                <li class="list-inline-item">
                                    Copyright &copy; 2024
                                    <a href="/admin" class="link-secondary">nickdaoquan.vn</a>.
                                    All rights reserved.
                                </li>
                            </ul>
                        </div>
